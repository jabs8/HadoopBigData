...
try:
    connection.disable_table('DW_Fromagerie')
    connection.delete_table('DW_Fromagerie')
    print('La table DW_Fromagerie est supprimée')
except Exception as e:
    pass
 
try:
    madesc = {'cf': dict()}  # Création de la famille 'cf'
    connection.create_table('DW_Fromagerie', madesc)
    print("La table DW_Fromagerie est créée")
except Exception as e:
    pass
